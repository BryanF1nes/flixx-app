const global = {
    ...
    api: {
        apikey: 'c4aee1098e6e4cc2a6c42975e90900b8',
...
async function search() {
    ...
    global.type = urlParams.get('type');
...
async function searchAPIData() {
    ...
    const response = await fetch(`${API_URL}search/movie${global.search.type}?api_key=${API_KEY}&language=en-US&query=${global.search.term}&page=${global.search.page}`);
...
// Shows the spinner on fetch
function showSpinner() {
    document.querySelector('.spinner').classList.add('show');
}

// hides the spinner before returning the data
